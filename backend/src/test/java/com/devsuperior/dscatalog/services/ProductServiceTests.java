...
public class ProductServiceTests {
	...
	void setUp() throws Exception {
		...
		Mockito.when(categoryRepository.getOne(existingId)).thenReturn(new Category(1L, "teste"));
	...
	@Test
	public void updateShouldThrowResourceNotFoundyExceptionWhenIdNotExist() {

		Assertions.assertThrows(ResourceNotFoundyException.class, () -> {
	...
	@Test
	public void findbyIdShouldThrowResourceNotFoundyExceptionWhenIdNotExist() {
	...
	@Test
	public void findByPagedSholdReturnPage() {
	...
	@Test
	public void deleteShouldThrowResourceNotFoundyExceptionWhenIdNotExist() {
